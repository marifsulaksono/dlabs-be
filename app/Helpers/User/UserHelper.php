 ...
 * Mengambil data, menambah, mengubah, & menghapus ke tabel user
 *
 * @author Wahyu Agung <wahyuagung26@gmail.com>
 */
class UserHelper extends Common
{
    ...
    /**
     * method untuk menginput data baru ke tabel user
     *
     * @param  array  $payload
     *                          $payload['name'] = string
     ...
     *
     * @param  int  $id  id dari tabel user
     */
    ...
    /**
     * Mengambil 1 data user dari tabel user
     *
     * @param  int  $id  id dari tabel user
     */
    ...
    /**
     * method untuk mengubah user pada tabel user
     *
     * @param  array  $payload
     *                          $payload['name'] = string
     *                          $payload['email] = string
